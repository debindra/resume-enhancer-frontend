  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-6 px-4 py-8 sm:space-y-8 sm:px-6 sm:py-12">
      <div className="space-y-3 sm:space-y-4">
        <h1 className="text-3xl font-bold text-neutral sm:text-4xl md:text-5xl">Privacy Policy</h1>
      ...
      <div className="prose max-w-none space-y-6 text-sm text-neutral-light sm:text-base">
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">1. Introduction</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">2. Information We Collect</h2>
          <h3 className="text-lg font-semibold text-neutral sm:text-xl">2.1 Information You Provide</h3>
          ...
          <h3 className="text-lg font-semibold text-neutral mt-4 sm:text-xl">2.2 Automatically Collected Information</h3>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">3. How We Use Your Information</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">4. Data Storage and Security</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">5. Third-Party Services</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">6. Your Rights</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">7. Cookies</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">8. Children's Privacy</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">9. Changes to This Policy</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">10. Contact Us</h2>
          <p>
