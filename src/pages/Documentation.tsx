      ...
      <div className="space-y-8">
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <div className="space-y-4 text-slate-700">
            ...
            <div>
              ...
              <p>Yes, we use industry-standard encryption and don't store your resume without your explicit consent. See our <Link to="/privacy-policy" className="text-indigo-600 hover:underline">Privacy Policy</Link> for details.</p>
            </div>
          </div>
        </section>
        ...
        <section className="rounded-2xl border border-indigo-200 bg-indigo-50 p-8">
          ...
          <p className="mb-4 text-indigo-800">
            Can't find what you're looking for? Check out our <Link to="/#faq" className="font-semibold underline">FAQ section</Link> or contact our support team.
          </p>
          <a
