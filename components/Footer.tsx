        ...
        <div className="grid gap-6 sm:gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-600">
              ...
              <li>
                <Link href="/documentation" className="transition hover:text-indigo-600">
                  Documentation
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-600">
              <li>
                <Link href="/privacy-policy" className="transition hover:text-indigo-600">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms-of-service" className="transition hover:text-indigo-600">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link href="/cookie-policy" className="transition hover:text-indigo-600">
                  Cookie Policy
                </Link>
              </li>
            </ul>
