...
const blogPosts: Record<string, {
  ...
  "power-of-quantifiable-achievements": {
    ...
    content: [
      ...
      { type: 'text', content: "Even if you don't have exact numbers, estimates work. 'Reduced processing time by approximately 40%' is still way better than 'improved efficiency.'" },
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!post) {
    return {
      title: "Post Not Found | Resume Enhancer",
    };
  }

  return {
    title: `${post.title} | Resume Enhancer Blog`,
