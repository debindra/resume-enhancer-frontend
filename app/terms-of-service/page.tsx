  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-6 px-4 py-8 sm:space-y-8 sm:px-6 sm:py-12">
      <div className="space-y-3 sm:space-y-4">
        <h1 className="text-3xl font-bold text-neutral sm:text-4xl md:text-5xl">Terms of Service</h1>
      ...
      <div className="prose max-w-none space-y-6 text-sm text-neutral-light sm:text-base">
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">1. Acceptance of Terms</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">2. Description of Service</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">3. User Accounts</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">4. Acceptable Use</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">5. Content and Intellectual Property</h2>
          <h3 className="text-lg font-semibold text-neutral sm:text-xl">5.1 Your Content</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold text-neutral mt-4 sm:text-xl">5.2 Our Content</h3>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">6. AI-Generated Content</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">7. Service Availability</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">8. Payment and Billing</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">9. Disclaimer of Warranties</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">10. Limitation of Liability</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">11. Termination</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">12. Changes to Terms</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">13. Governing Law</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral sm:text-2xl">14. Contact Information</h2>
          <p>
